...
DATASET_NAME=prolong

MODEL_NAME=meta-llama/Llama-3.2-1B
MODEL_PATH=$MODEL_NAME

TOKENIZED_DATASET=~/rmt/datasets/prolong/prolong_64k_tokenized
VALID_TOKENIZED_DATASET=~/rmt/datasets/pg19/pg19_tokenized
ITERS=50000
TBS=256
# TBS=32
BS=4
...
# MODEL_CPT=../runs/pg19/meta-llama/Llama-3.2-1B/linear_adamw_wd1e-03_2x1024_mem16_bs256_bptt--1_nfs/run_1/checkpoint-49500/pytorch_model.bin
...
accelerate launch --config_file $ACCEL_CONFIG --main_process_port 29002 --num_processes $NP run_finetuning_lm_rmt_hf.py \
        ...
        --valid_tokenized_dataset $VALID_TOKENIZED_DATASET \
